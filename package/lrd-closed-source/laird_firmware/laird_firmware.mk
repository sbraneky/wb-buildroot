...
ifeq ($(BR2_PACKAGE_LAIRD_FIRMWARE_IW612),y)
define LAIRD_FW_IW612_INSTALL_TARGET_CMDS
	mkdir -p -m 0755 $(TARGET_DIR)/lib/firmware/iw612
	cp $(@D)/iw612/*_v1.bin.se $(TARGET_DIR)/lib/firmware/iw612
endef
endif

ifeq ($(BR2_PACKAGE_LAIRD_FIRMWARE_IW612_MFG),y)
define LAIRD_FW_IW612_MFG_INSTALL_TARGET_CMDS
	mkdir -p -m 0755 $(TARGET_DIR)/lib/firmware/iw612
	cp $(@D)/iw612/mfg/*_mfg.bin.se $(TARGET_DIR)/lib/firmware/iw612
endef
endif
...
define LAIRD_FIRMWARE_INSTALL_TARGET_CMDS
	...
	$(LAIRD_FW_IW612_INSTALL_TARGET_CMDS)
	$(LAIRD_FW_IW612_MFG_INSTALL_TARGET_CMDS)
endef
